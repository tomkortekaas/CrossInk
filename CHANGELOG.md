...
- Reopening an EPUB after sleep now returns to the first page at the saved text position instead of jumping back one page when adjacent pages share that position.
